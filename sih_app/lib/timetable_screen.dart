            ...
            Expanded(
              child: Center(
                ...
                itemBuilder: (context, dayIndex) {
                  ...
                  final List<String> periods = TimetableData.periodsForDay(day);
                  final bool isToday = day == TimetableData.todayName();
                  return Container(
                    decoration: BoxDecoration(
                      color: isToday
                          ? const Color(0xFFFF7FA8) // pink highlight for today
                          : const Color(0xFF00BFFF), // sky blue background for others
